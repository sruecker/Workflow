package view.graphic {
	...
	public class Balloon extends Sprite {
		...
		private var arrowWidth:Number = 16;					// Balloon's arrow point width
		private var arrowHeight:Number = 8;				// Balloon's arrow point height
		...
		public function Balloon(w:Number, h:Number) {
			...
			var fxGlow:BitmapFilter = getBitmapFilter(0x000000, .3);
			fxs.push(fxGlow);
			this.filters = fxs;
