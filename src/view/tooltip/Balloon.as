package view.tooltip {
	...
	public class Balloon extends Sprite {
		...
		protected var _arrowWidth					:Number = 10;					// Balloon's arrow point width
		protected var _arrowHeight					:Number = 5;					// Balloon's arrow point height
		...
		public function init(w:Number, h:Number):void {
			...
			_activeArea = new Rectangle(balloon.x,balloon.y,balloon.width,balloon.height);
